...
for j,N in enumerate(N_list):
    ...
    csv_file_path_MC = f"/Users/bouningen0909/dissertation/week_7/data/cubic_{N}/monte_carlo/N_{N}epsilon_prob_mass.csv"
    ...
    if N == 64:
        for k, epsilon in enumerate(SS_epsilon_list):
            ...
            csv_file_path_SS = f"/Users/bouningen0909/dissertation/week_7/data/cubic_{N}/outbreak_count{N}_comp_eps{epsilon}R2.csv"
...
plt.title("Transition in three-dimensional lattice",fontsize=12)
plt.legend(fontsize=12,loc = 'best',bbox_to_anchor=(0.6, 0.11, 0.5, 0.5))
plt.savefig("/Users/bouningen0909/dissertation/week_7/data/lattice_transition/3D_transition_plot.png",dpi=300,bbox_inches='tight')
plt.show()
